...
geol_sigs_camels_long <- pivot_longer(geol_sigs_camels_plotting, cols = c(-av_age,-av_age_w, -gauge_id), names_to = "signature", values_to = "sig_value")

# Create scatterplot with facetting
geol_sigs_scatterplot <- ggplot(geol_sigs_camels_long, aes(x = av_age_w, y = sig_value)) +
